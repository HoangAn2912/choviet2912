...
<div class="qldonhang-container">
    ...
    <div class="filters">
        <form method="GET">
            ...
            <div class="form-group">
                ...
                <a href="?qldonhang" class="btn btn-info" style="margin-left: 10px;">Đặt lại</a>
            </div>
        </form>
    </div>
    ...
    <?php if ($total_pages > 1): ?>
        <div class="pagination">
            <?php if ($page > 1): ?>
                <a href="?qldonhang&page=<?php echo $page - 1; ?>&status=<?php echo $status_filter; ?>&livestream_id=<?php echo $livestream_filter; ?>&user_id=<?php echo $user_filter; ?>&start_date=<?php echo $start_date; ?>&end_date=<?php echo $end_date; ?>">« Trước</a>
            <?php endif; ?>
            ...
            <?php for ($i = max(1, $page - 2); $i <= min($total_pages, $page + 2); $i++): ?>
                ...
                <?php else: ?>
                    <a href="?qldonhang&page=<?php echo $i; ?>&status=<?php echo $status_filter; ?>&livestream_id=<?php echo $livestream_filter; ?>&user_id=<?php echo $user_filter; ?>&start_date=<?php echo $start_date; ?>&end_date=<?php echo $end_date; ?>"><?php echo $i; ?></a>
                <?php endif; ?>
            <?php endfor; ?>
            
            <?php if ($page < $total_pages): ?>
                <a href="?qldonhang&page=<?php echo $page + 1; ?>&status=<?php echo $status_filter; ?>&livestream_id=<?php echo $livestream_filter; ?>&user_id=<?php echo $user_filter; ?>&start_date=<?php echo $start_date; ?>&end_date=<?php echo $end_date; ?>">Sau »</a>
            <?php endif; ?>
        </div>
    <?php endif; ?>
</div>
