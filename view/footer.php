    ...
    <div class="container-fluid bg-dark text-secondary mt-3 pt-5">
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                ...
                <p class="mb-2">CÔNG TY TNHH CHỢ VIỆT - Người đại diện: Nguyễn Phúc Hoàng An, Trần Thái Bảo;</p>
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Số 14 đường Nguyễn Văn Bảo, Phường 4, Quận Gò Vấp, Thành phố Hồ Chí Minh, Việt Nam;</p>
                <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>trogiup@choviet.vn </p>
                <p class="mb-0"><i class="fa fa-phone-alt text-primary mr-3"></i>Tổng đài CSKH: 19003003 (1.000đ/phút)</p>
            </div>
